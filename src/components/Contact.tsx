...
const Contact = () => {
  ...
  const formCompletion = Object.values(formData).filter(value => value.trim() !== '').length * 20;
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl sm:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Ready to connect your brand with the gaming audience? Let's start the conversation.
          </p>
        </div>
          ...
          <div className="bg-black border border-gray-800 rounded-2xl p-8 sm:p-10 relative overflow-hidden neon-edge">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center justify-between mb-8">
                <h3 className="text-xl sm:text-2xl font-bold text-white animate-hud-flicker">Get in Touch</h3>
              ...
              <div className="mb-8">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-xs text-gray-400 font-mono">FORM COMPLETION</span>
                  <span className="text-xs text-gray-400 font-mono">{formCompletion}%</span>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="firstName" className="block text-xs sm:text-sm font-medium text-gray-300 mb-2 font-mono">
                      First Name *
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="lastName" className="block text-xs sm:text-sm font-medium text-gray-300 mb-2 font-mono">
                      Last Name *
                    </label>
                    <input
                      type="text"
                ...
                <div>
                  <label htmlFor="email" className="block text-xs sm:text-sm font-medium text-gray-300 mb-2 font-mono">
                    Email *
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  <label htmlFor="phone" className="block text-xs sm:text-sm font-medium text-gray-300 mb-2 font-mono">
                    Phone Number
                  </label>
                  <input
                    type="tel"
                ...
                <div>
                  <label htmlFor="message" className="block text-xs sm:text-sm font-medium text-gray-300 mb-2 font-mono">
                    Message *
                  </label>
                  <textarea
                    id="message"
                ...
                {submitStatus === 'success' && (
                  <div className="flex items-center space-x-2 text-green-400 bg-green-400/10 border border-green-400/20 rounded-lg p-3 sm:p-4">
                    ...
                    <span className="text-sm sm:text-base">Thank you! Your message has been sent successfully. We'll get back to you soon.</span>
                  </div>
                )}
                ...
                {submitStatus === 'error' && (
                  <div className="flex items-center space-x-2 text-red-400 bg-red-400/10 border border-red-400/20 rounded-lg p-3 sm:p-4">
                    ...
                    <span className="text-sm sm:text-base">Error: {errorMessage}. Please try again.</span>
                  </div>
                )}
              </form>
            </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-300 text-base sm:text-lg leading-relaxed mb-6 sm:mb-8 px-4 lg:px-0">
                Whether you're looking to break into gaming marketing or scale your existing efforts, we're here to help you navigate the gaming ecosystem and achieve measurable results.
              </p>
            </div>
            ...
            <div className="space-y-4 sm:space-y-6 px-4 lg:px-0">
              <div className="flex items-start space-x-4 group">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1 animate-hud-flicker text-sm sm:text-base">Email Us</h4>
                  <p className="text-gray-400 font-mono text-sm sm:text-base">hello@hashku.com</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-4 sm:p-6 mt-6 sm:mt-8 mx-4 lg:mx-0">
              <h4 className="text-white font-semibold text-base sm:text-lg mb-3 sm:mb-4">Why Brands Work With Hashku</h4>
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  <div className="w-1.5 h-1.5 bg-yellow-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-300 leading-relaxed text-sm sm:text-base">Gaming-native, commerce-driven.</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-1.5 h-1.5 bg-yellow-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-300 leading-relaxed text-sm sm:text-base">Full-funnel strategy.</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-1.5 h-1.5 bg-yellow-400 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-300 leading-relaxed text-sm sm:text-base">Trusted to drive measurable growth.</p>
                </div>
              </div>
            </div>
          </div>
