  ...
  const services = [
    {
      ...
      subtitle: "In-Game",
      description:
        "Brand integrations into some of the most popular, brand-safe games to reach and connect with existing audiences at scale.",
      features: [
        "Native game placements",
        "Virtual brand experiences",
        "Custom gaming assets",
      ],
    ...
    },
    {
      ...
      description:
        "Targeted advertising across mobile, console, and PC gaming to reach audiences where they play.",
      features: [
        "Gaming platform ads",
    ...
    },
    {
      ...
      description:
        "Creator-driven content, social campaigns, and cultural storytelling that connects gaming culture with your brand narrative.",
      features: [
        "Gaming creator partnerships",
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-24">
          ...
          <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Our integrated approach ensures your brand shows up authentically
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div
                  className={`w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 ${service.iconBg} rounded-2xl sm:rounded-3xl flex items-center justify-center mx-auto mb-6 sm:mb-8 group-hover:scale-105 transition-all duration-300 shadow-lg relative overflow-hidden hud-corners neon-edge`}
                >
                ...
                <div className="mb-6">
                  <h3 className="text-2xl sm:text-3xl font-bold text-black mb-2 group-hover:text-gray-800 transition-colors">
                    {service.title}
                  </h3>
                  <p className="text-lg sm:text-xl text-yellow-600 font-semibold animate-hud-flicker">
                    {service.subtitle}
                  </p>
                </div>
