          ...
          {insights.map((insight, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className={`w-12 h-12 sm:w-16 sm:h-16 bg-yellow-400 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:scale-105 transition-all duration-300 shadow-xl shadow-yellow-400/25 group-hover:shadow-yellow-400/40 relative overflow-hidden hud-corners neon-edge`}>
                ...
                {/* Enhanced Label */}
                <h3 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4">{insight.label}</h3>

                {/* Enhanced Description */}
                <p className="text-sm sm:text-base text-gray-300 leading-relaxed">{insight.description}</p>
              </div>
            </div>
          ))}
        </div>
