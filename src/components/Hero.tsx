    ...
    <section className="pt-16 min-h-screen bg-black relative overflow-hidden flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 z-20">
        <div className="text-center">
          ...
          <h1
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-white mb-8 sm:mb-10 leading-[0.9] tracking-tight relative"
            itemProp="headline"
          >
            <span className="relative">Turn Gameplay Into</span>
          ...
          <p
            className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-gray-300 max-w-5xl mx-auto mb-12 sm:mb-16 leading-relaxed font-light"
